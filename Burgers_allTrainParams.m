...
statePredictionErrorHFLSPG = zeros(size(latTol,1),N1,N2);
statePredictionErrorHFGalerkin = zeros(size(latTol,1),N1,N2);
statePredictionErrorECSWLSPG1e5 = zeros(size(latTol,1),N1,N2);
statePredictionErrorECSWLSPG1e9 = zeros(size(latTol,1),N1,N2);
statePredictionErrorECSWGalerkin1e5 = zeros(size(latTol,1),N1,N2);
statePredictionErrorECSWGalerkin1e9 = zeros(size(latTol,1),N1,N2);
...
x_hat_hist = zeros(N1,N2,numModes,Nt);
ROMtime = zeros(N1,N2);
...
x_hist_test = zeros(N1,N2,N,Nt);
allTimes = zeros(N1,N2);
